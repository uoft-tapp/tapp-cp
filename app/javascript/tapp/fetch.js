...
const getInstructors = () =>
    getResource(
        "/instructors",
        fetchProc.onFetchInstructorsSuccess,
        "instructors",
        appState.setInstructorsList,
        false
    );
...
const getApplicants = () =>
    getResource(
        "/applicants",
        fetchProc.onFetchApplicantsSuccess,
        "applicants",
        appState.setApplicantsList
    );

const getApplications = () =>
    getResource(
        "/applications",
        fetchProc.onFetchApplicationsSuccess,
        "applications",
        appState.setApplicationsList
    );

const getCourses = () =>
    getResource(
        "/positions",
        fetchProc.onFetchTappCoursesSuccess,
        "courses",
        appState.setCoursesList
    );

const getAssignments = () =>
    getResource(
        "/assignments",
        fetchProc.onFetchAssignmentsSuccess,
        "assignments",
        appState.setAssignmentsList
    );
...
export const exportOffers = (round, session) => {
    downloadFile("/export/chass/sessions/" + session + "/" + round).then(() =>
        getAssignments()
    );
};
...
export const fetchAuth = () => {
    return fetchProc.setRole(
        ["tapp_admin", "instructor", "tapp_assistant"],
        false,
        appState
    );
};
