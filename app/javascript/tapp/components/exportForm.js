    ...
    exportData(data, format) {
        ...
        if (data == "offers") {
            ...
            if (Object.keys(this.props.getAssignmentsList()).length == 0) {
                ...
                this.props.alert(
                    "Cannot export offers: no assignments have been made"
                );
                return;
            }
            ...
            if (
                data == "cdf-info" &&
                Object.keys(this.props.getAssignmentsList()).length == 0
            ) {
                // no assignments have been made
                this.props.alert(
                    "Cannot export CDF info: no assignments have been made"
                );
                return;
            }
            ...
            <Form inline id="export">
                ...
                <FormControl.Static style={{ verticalAlign: "middle" }}>
                    ...
                    <i
                        ...
                        onClick={() =>
                            this.exportData(this.data.value, this.format.value)
                        }
                    />
                </FormControl.Static>
            </Form>
