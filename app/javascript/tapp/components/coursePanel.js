        ...
        this.config = [
            {
                ...
                data: p => {
                    if (p.assigned) {
                        let assignment = props.getAssignmentByApplicant(
                            p.applicantId,
                            p.course
                        );
            ...
            },
            {
                        ...
                        .reduce(
                            (str, ass) =>
                                ass.positionId == p.course
                                    ? str
                                    : str +
                                      props.getCourseCodeById(ass.positionId) +
                                      ", ",
                            ""
                        ),
                ...
                filterFuncs: [
                    ...
                    p =>
                        props.getAssignmentsByApplicant(p.applicantId).length >
                        0,
                ...
                <div className="panel-body">
                    ...
                    <ApplicantTableMenu
                        ...
                        getSelectedSortFields={() =>
                            this.props.getCoursePanelSortsByCourse(
                                this.props.course
                            )
                        }
                        anyFilterSelected={field =>
                            this.props.anyCoursePanelFilterSelected(
                                this.props.course,
                                field
                            )
                        }
                        ...
                        toggleFilter={(field, category) =>
                            this.props.toggleCoursePanelFilter(
                                this.props.course,
                                field,
                                category
                            )
                        ...
                        clearFilters={() =>
                            this.props.clearCoursePanelFilters(
                                this.props.course
                            )
                        }
                        addSort={field =>
                            this.props.addCoursePanelSort(
                                this.props.course,
                                field
                            )
                        }
                        removeSort={field =>
                            this.props.removeCoursePanelSort(
                                this.props.course,
                                field
                            )
                        }
                        toggleSortDir={field =>
                            this.props.toggleCoursePanelSortDir(
                                this.props.course,
                                field
                            )
                        }
...
const UnassignedApplicantTable = props => (
    <ApplicantTable
        ...
        course={props.course}
        getApplicants={() =>
            props.getApplicantsToCourseUnassigned(props.course)
        }
        getSelectedSortFields={() =>
            props.getCoursePanelSortsByCourse(props.course)
        }
        getSelectedFilters={() =>
            props.getCoursePanelFiltersByCourse(props.course)
        }
