...
const ViewTab = props => (
    <li
        role="presentation"
        className={props.activeKey == props.id ? "active" : ""}
    >
...
const Round = props => {
    ...
    style.sheet.insertRule(
        ".round-all {background-color: " + roundColourConfig["all"] + "}",
        0
    );
    ...
    return (
        <NavDropdown
            title={
                <span
                    className={
                        "round-" + (selectedRound ? selectedRound : "all")
                    }
                    style={{
                        color: "#fff",
                        padding: "6px 12px",
                    ...
                    round != selectedRound && (
                        <MenuItem eventKey={round} key={round}>
                            ...
                            <i
                                ...
                                style={{ color: roundColourConfig[i] }}
                            />
                        </MenuItem>
                    )
            )}
...
const Notifications = props => {
    ...
    return (
        <NavDropdown
            ...
            title={
                <span>
                    <i className="fa fa-bell-o" style={{ fontSize: "16px" }} />
            ...
            {roles.map(
                r =>
                    role != r && (
                        <MenuItem
                            key={"switch-" + r}
                            onClick={() => props.selectUserRole(r)}
                        >
                            Switch to {r} role
                        </MenuItem>
                    )
...
const NavbarInst = props => (
    <Navbar fixedTop fluid>
        ...
        <Nav pullRight>
            ...
            {props.role == "tapp_admin" || props.role == "instructor" ? (
                <Session {...props} />
            ) : (
                ""
            )}
